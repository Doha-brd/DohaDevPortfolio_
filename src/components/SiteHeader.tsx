...
const RESUME_DRIVE_VIEW_URL = "/DohaDev.pdf";
const RESUME_DRIVE_DOWNLOAD_URL = "/DohaDev.pdf";
...
const socialProfiles = [
  {
    ...
    Icon: FaGithub,
    previewSrc: buildPreviewShot("https://github.com/Doha-brd"),
  },
] as const;
        ...
        {hovered && (
          ...
          >
            <div className="nav-social-card-chrome">
              ...
              <span className="chrome-dot chrome-dot-pink" />
  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="brand-first">Doha</span>
          <span className="brand-last">Berrachid</span>
        </motion.div>
