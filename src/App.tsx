...
import { FaJs, FaPhp, FaReact, FaNodeJs } from "react-icons/fa";
...
const techBadges: TechBadge[] = [
  ...
  { label: "JS", icon: FaJs, left: "10%", top: "48%", delay: "0.4s" },
  { label: "PHP", icon: FaPhp, left: "24%", top: "28%", delay: "0.8s" },
  { label: "Laravel", icon: SiLaravel, left: "40%", top: "14%", delay: "1.2s" },
  { label: "Tailwind", icon: SiTailwindcss, left: "58%", top: "12%", delay: "1.6s" },
  { label: "Node.js", icon: FaNodeJs, left: "76%", top: "24%", delay: "2s" },
  { label: "MongoDB", icon: SiMongodb, left: "90%", top: "44%", delay: "2.4s" },
  { label: "MySQL", icon: SiMysql, left: "98%", top: "68%", delay: "2.8s" },
];
...
function AppContent() {
  ...
  return (
    <div className="page-root">
      ...
      {/* About Me — deep olive dark, pink-tinted blobs */}
      <SectionBlock
        id="about"
        ...
        <SectionReveal>
          ...
          >
            ...
            <div className="about-copy">
              ...
              <p>
                Hi! I&apos;m Doha Berrachid, a full-stack developer specializing in building modern, high-performance web applications.
              </p>
              <p>
                I develop responsive and intuitive user interfaces with React and Tailwind CSS, and build scalable backend systems using PHP Laravel, Node.js, and Python. I focus on writing clean, maintainable code and delivering reliable, user-centered solutions that combine performance, functionality, and great user experience.
              </p>
              <blockquote className="about-quote">
                Building tomorrow with today&apos;s technologies.
              </blockquote>
            </div>
          </motion.div>
        </SectionReveal>
      ...
      {/* Projects — dark charcoal, warm pink blobs */}
      <SectionBlock
        id="projects"
      ...
      {/* Experience — dark olive-green, muted pink blobs */}
      <SectionBlock
        id="experience"
